# MemOS + Qdrant + Reranker — Technical Reference

> This document contains full technical details. For a quick start, see [README.md](../README.md).
...
### Vector Retrieval: SQLite vs Qdrant
