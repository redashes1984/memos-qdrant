...
const StorageSchema = Type.Object({
  /** Vector backend: "sqlite" (default, in-DB brute force) or "qdrant". */
  vectorBackend: Type.Union([
    Type.Literal("sqlite"),
    Type.Literal("qdrant"),
  ], { default: "sqlite" }),
  qdrant: Type.Object({
    ...
    apiKey: StringWithDefault(""),
    collectionPrefix: StringWithDefault("memos"),
    timeoutMs: NumberInRange(10_000, 1_000, 60_000),
    maxRetries: NumberInRange(3, 0, 10),
  }, { default: {} }),
}, { default: {} });
...
const RerankerSchema = Type.Object({
  enabled: Bool(false),
  endpoint: StringWithDefault(""),
  model: StringWithDefault(""),
  topN: NumberInRange(10, 1, 100),
  timeoutMs: NumberInRange(30_000, 1_000, 60_000),
  maxRetries: NumberInRange(3, 0, 10),
}, { default: {} });
